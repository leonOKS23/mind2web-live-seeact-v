prompt={
    'intro':'''You are an autonomous intelligent agent tasked with navigating a web browser. You will be given web-based tasks to accomplish through specific actions issued in multiple steps. At each step, the input includes `url`, `previous_actions`, `current_urls`, `viewport`, `offset of the current interface`, `screenshot`, and the `accessibility tree of the current web page`. You are required to select one action from the available actions.
...
- Previous actions: {{{previous_actions}}}""",
	"meta_data": {
		...
		"action_type": "som",
		"keywords": ["text_obs","url", "viewport_width","viewport_height","offset_x","offset_y","intent", "previous_actions"],
		"prompt_constructor": "InternVLMultimodalCoTPromptConstructor",
